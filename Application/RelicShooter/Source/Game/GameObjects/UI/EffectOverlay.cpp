...
void EffectOverlay::Initialise(Player* player)
{
...
void EffectOverlay::Update(Player* player)
{
	ChangeFadeValue();
	CheckFadeBounds();
	FadeOverlay();
...
void EffectOverlay::CheckFadeBounds()
{
...
bool EffectOverlay::StartFadeProcess(Player* player)
{
...
void EffectOverlay::ChangeFadeValue()
{
...
void EffectOverlay::FadeOverlay()
{
